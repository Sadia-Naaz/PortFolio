...
const HeroSection = () => {
  return (
    <div className="min-h-screen px-6 py-10  text-white flex flex-col gap-12 lg:flex-row lg:justify-between lg:items-center overflow-hidden">
      ...
      <motion.div
        ...
        className="w-96 h-96 rounded-full bg-gradient-to-tr from-indigo-500 via-pink-500 to-purple-600 p-1 shrink-0"
      >
        <img
